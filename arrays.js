...
describe("Ejercicios de Arreglos con pruebas TDD en mocha", function() {
    ...
    describe("Ejercicio 2", function() { // describe: agrupa las pruebas
        ...
        it("arr = [78412397, 918374817841, 2173784, 784129837, 3487396478, 2348798] y array2= [] debe ser arr", function() { //it:   define cada uno de las casos de prueba
            var arr = [78412397, 918374817841, 2173784, 784129837, 3487396478, 2348798];
            var validos = [];
            assert.deepEqual(ejercicio2(arr, validos), arr);
        });
    });
